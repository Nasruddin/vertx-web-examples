...
public class RunnerUtil {
    ...
    static class JSAuthRunner {
        public static void main(String[] args) {
            RunnerUtil.runJSExample("io/vertx/example/web/auth/server.js");
        }
    }

    static class JSAuthJDBC {
        public static void main(String[] args) {
            RunnerUtil.runJSExample("io/vertx/example/web/authjdbc/server.js");
        }
    }

    static class JSHelloWorldRunner {
        public static void main(String[] args) {
            RunnerUtil.runJSExample("io/vertx/example/web/helloworld/server.js");
        }
    }

    static class JSRealtimeRunner {
        public static void main(String[] args) { RunnerUtil.runJSExample("io/vertx/example/web/realtime/server.js"); }
    }

    static class JSChatRunner {
        public static void main(String[] args) {
            RunnerUtil.runJSExample("io/vertx/example/web/chat/server.js");
        }
    }

    static class JSSessionsRunner {
        public static void main(String[] args) {
            RunnerUtil.runJSExample("io/vertx/example/web/sessions/server.js");
        }
    }

    static class JSTemplatingRunner {
        public static void main(String[] args) {
            RunnerUtil.runJSExample("io/vertx/example/web/templating/mvel/server.js");
        }
    }
    ...
    static class GroovyAuthRunner {
        public static void main(String[] args) {
            RunnerUtil.runGroovyExample("io/vertx/example/web/auth/server.groovy");
        }
    }

    static class GroovyAuthJDBC {
        public static void main(String[] args) {
            RunnerUtil.runGroovyExample("io/vertx/example/web/authjdbc/server.groovy");
        }
    }

    static class GroovyHelloWorldRunner {
        public static void main(String[] args) {
            RunnerUtil.runGroovyExample("io/vertx/example/web/helloworld/server.groovy");
        }
    }

    static class GroovyChatRunner {
        public static void main(String[] args) { RunnerUtil.runGroovyExample("io/vertx/example/web/chat/server.groovy"); }
    }

    static class GroovyRealtimeRunner {
        public static void main(String[] args) {
            RunnerUtil.runGroovyExample("io/vertx/example/web/realtime/server.groovy");
        }
    }

    static class GroovySessionsRunner {
        public static void main(String[] args) {
            RunnerUtil.runGroovyExample("io/vertx/example/web/sessions/server.groovy");
        }
    }

    static class GroovyTemplatingRunner {
        public static void main(String[] args) {
            RunnerUtil.runGroovyExample("io/vertx/example/web/templating/mvel/server.groovy");
        }
    }

    static class GroovyRestRunner {
        public static void main(String[] args) {
            RunnerUtil.runGroovyExample("io/vertx/example/web/rest/simple_rest.groovy");
        }
    }
    ...
    static class RubyAuthRunner {
        public static void main(String[] args) {
            RunnerUtil.runRubyExample("io/vertx/example/web/auth/server.rb");
        }
    }

    static class RubyAuthJDBC {
        public static void main(String[] args) {
            RunnerUtil.runRubyExample("io/vertx/example/web/authjdbc/server.rb");
        }
    }
    static class RubyHelloWorldRunner {
        public static void main(String[] args) {
            RunnerUtil.runRubyExample("io/vertx/example/web/helloworld/server.rb");
        }
    }

    static class RubyChatRunner {
        public static void main(String[] args) { RunnerUtil.runRubyExample("io/vertx/example/web/chat/server.rb");
        }
    }

    static class RubyRealtimeRunner {
        public static void main(String[] args) {
            RunnerUtil.runRubyExample("io/vertx/example/web/realtime/server.rb");
        }
    }

    static class RubySessionsRunner {
        public static void main(String[] args) {
            RunnerUtil.runRubyExample("io/vertx/example/web/sessions/server.rb");
        }
    }

    static class RubyTemplatingRunner {
        public static void main(String[] args) {
            RunnerUtil.runRubyExample("io/vertx/example/web/templating/mvel/server.rb");
        }
    }
